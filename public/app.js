...
},{"./is-function":358,"./is-object":359,"./request-base":360,"./response-base":361,"./should-retry":362,"emitter":29}],358:[function(require,module,exports){
/**
...
},{"./update-events.js":366,"bel":27,"morphdom":351}],366:[function(require,module,exports){
module.exports = [
...
function lang(locale) {
  ...
  location.reload();
  return false; //para quitar el # del boton
}

document.body.appendChild(el);
//cuando la clase no la tenga no le muestra el corazon lleno
...
},{"../translate":381,"empty-element":324,"yo-yo":365}],369:[function(require,module,exports){
...
function loadPictures(ctx, next) {
	request.get('/api/pictures') //err de si es error 404 500 2000 y res para la respuesta del contenido que envia el servidor en este caso los pictures 
	...
	return regeneratorRuntime.async(function asyncLoad$(_context) {
		while (1) switch (_context.prev = _context.next) {
			case 0:
				_context.prev = 0;
				_context.next = 3;
				return regeneratorRuntime.awrap(fetch('/api/pictures').then(res => res.json()));
...
},{"../header":368,"./template":370,"axios":1,"empty-element":324,"page":353,"superagent":357,"title":364}],370:[function(require,module,exports){
var yo = require('yo-yo');
...
},{"../layout":373,"../picture-card":374,"../translate":381,"superagent":357,"yo-yo":365}],371:[function(require,module,exports){
...
},{"./footer":367,"./homepage":369,"./signin":375,"./signup":377,"./user-page":382,"babel-polyfill":26,"page":353}],372:[function(require,module,exports){
var yo = require('yo-yo');
//buena practica nombrar alas funciones
			...
			<div class="col s10 push-s1">
				<div class="row">
					<div class="col m5 hide-on-small-only">
						<img class="iphone"src="images.jpg" alt="">
					</div>
					${box}
				</div>
			</div>
...
},{"../translate":381,"yo-yo":365}],375:[function(require,module,exports){
...
},{"./template":376,"empty-element":324,"page":353,"title":364}],376:[function(require,module,exports){
var yo = require('yo-yo');
var landing = require('../landing');
var translate = require('../translate');

//subimos 2 carpetas y estamos en landing
	...
	<div class="row">
		<div class="signup-box">
			...
			<form action="" class="signup-form">
				<div class="section">
					<a href="" class="btn btn-fb hiden-on-small-only">${translate.message('signup.facebook')}</a>
...
//le pasamos de parametro el box
...
},{"./template":378,"empty-element":324,"page":353,"title":364}],378:[function(require,module,exports){
var yo = require('yo-yo');
var landing = require('../landing'); //subimos 2 carpetas y estamos en landing
var translate = require('../translate');
...
//projects.lukehass.me/css-loaders
...
module.exports = {
  ...
  'english': 'Ingles',
  'spanish': 'Español',
  'signup.subheading': 'Registrate para ver fotos de tus amigos estudiando',
...
},{"./en-US":379,"./es":380,"intl":346,"intl-messageformat":331,"intl-relativeformat":340,"intl-relativeformat/dist/locale-data/en.js":338,"intl-relativeformat/dist/locale-data/es.js":339,"intl/locale-data/jsonp/en-US.js":348,"intl/locale-data/jsonp/es.js":349}],382:[function(require,module,exports){
var page = require('page');
var header = require('../header');
var title = require('title');
var empty = require('empty-element');
	...
	return regeneratorRuntime.async(function loadUser$(_context) {
		while (1) switch (_context.prev = _context.next) {
			case 0:
				_context.prev = 0;
				_context.next = 3;
				return regeneratorRuntime.awrap(fetch(`/api/user/${ctx.params.username}`).then(res => res.json()));

			case 3:
				ctx.user = _context.sent;
				//sabemos que se va a resolver en algun momento
...
},{"../header":368,"./template":383,"empty-element":324,"page":353,"title":364}],383:[function(require,module,exports){
var yo = require('yo-yo');
var layout = require('../layout');
var translate = require('../translate').message;
